...
public class MetafieldmappingDAO {
	 ...
	 * @param oldvalue参数旧的配置??
	 * @param newvalue参数新的配置??
	 * @return 更新返回的json??
	 */
...
//			// 将成功信息放入jsonObj的msg对象??
//			jsonObj.put("msg", "登录超时,请注????重新登录!");
//			return jsonObj;
//		}
//		User user = (User)sre;
//		
...
//			// 将false放入jsonObj的success对象??
//			jsonObj.put("success", false);
//			// 将重复信息放入jsonObj的msg对象??
//			jsonObj.put("msg", "该配置名已存??");
//		} else {
//			// 执行修改操作，返回事务处理的结果
...
//	
	 ...
	 * @param name
	 * @return “地市编码配置?? 第一个是编码第二个是汉字名称   “资源表名到呈现名称映射配置”第????是汉字名??第二个是对应数据库表??
	 */
