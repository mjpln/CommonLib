...
//		listParams.add(param);
		...
		// 3. 
		String sql = "alter table aaa add(we clob)";
		try {
			Database.executeQueryReport(sql);//, param.toArray());
			// Database.executeNonQueryTransactionReport(listSqls, listParams);
		} catch (Exception e) {
